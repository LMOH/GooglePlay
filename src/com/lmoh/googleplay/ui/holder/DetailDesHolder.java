...
public class DetailDesHolder extends BaseHolder<AppInfo> {
	...
	private int getShortHeight() {
		...
		int widthMeasureSpec = MeasureSpec.makeMeasureSpec(width, MeasureSpec.EXACTLY);// 宽不变,
																						// 确定值,
																						// match_parent
		int heightMeasureSpec = MeasureSpec.makeMeasureSpec(2000, MeasureSpec.AT_MOST);// 高度包裹内容,
																						// wrap_content;当包裹内容时,
																						// 参1表示尺寸最大值,暂写2000,
																						// 也可以是屏幕高度
